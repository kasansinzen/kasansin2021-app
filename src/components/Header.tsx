    ...
    <div className="Header">
      ...
      <nav className="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
        <div className="container">
          ...
          <button className="navbar-toggler navbar-toggler-right text-uppercase bg-dark-section-1 text-white rounded" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">
